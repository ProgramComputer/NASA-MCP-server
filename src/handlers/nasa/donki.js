...
exports.nasaDonkiHandler = nasaDonkiHandler;
 ...
 */
function nasaDonkiHandler(params) {
    return __awaiter(this, void 0, void 0, function () {
        var type, startDate, endDate, typeEndpoints, endpoint, queryParams, result, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, api_client_1.nasaApiRequest)(endpoint, queryParams)];
                case 1:
                    result = _b.sent();
                    // Return the result
                ...
                case 2:
                    error_1 = _b.sent();
                    console.error('Error in DONKI handler:', error_1);
